  ...
  return (
    <button
      ...
      style={{
        ...
        background: isMatched ? 'rgba(255, 107, 107, 0.1)' : 'var(--bg-surface)',
        ...
        perspective: '1000px',
        boxShadow: isMatched
          ? 'inset 0 2px 8px rgba(255, 107, 107, 0.2)'
          : 'var(--shadow-sm)',
...
export default function CatMatchBoard() {
...
function Game({ onNewGame }) {
  ...
  const totalPairs = CAT_PAIRS.length
  ...
  return (
    <div className="flex flex-col items-center gap-5 w-full max-w-lg mx-auto">
      ...
      >
        Tap cards to flip them and find matching pairs of cats!
      </p>
